...
import { DashboardEmbeddableInput } from 'src/legacy/core_plugins/dashboard_embeddable/public/embeddable/dashboard_container';
...
export class DashboardAppController {
  ...
  constructor({
    ...
    const refreshDashboardEmbeddable = () => {
      ...
      const mergedInput = {
        ...dashboardEmbeddable.getInput(),
        ...dashboardInput,
      };
      if (!_.isEqual(dashboardEmbeddable.getInput(), mergedInput)) {
        dashboardEmbeddable.setInput({
          ...dashboardEmbeddable.getInput(),
          ...dashboardInput,
        });
      }
    ...
    dashboardFactory
      ...
      .then((dashboardEmbeddableIn: DashboardContainer) => {
        ...
        dashboardEmbeddable.subscribeToOutputChanges(output => {
